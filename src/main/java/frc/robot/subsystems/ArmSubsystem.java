...
public class ArmSubsystem extends SubsystemBase {
    ...
    public ArmSubsystem() {
        ...
        m_encoder = new CANcoder(ArmConstants.kFrontCANID, "kachow");
        ...
        m_front = new TalonFX(ArmConstants.kFrontCANID, "kachow");
        m_front.getConfigurator().apply(config);
        m_rear = new TalonFX(ArmConstants.kRearCANID, "kachow");
        ...
        m_rearLog = new TalonFXStandardSignalLogger(m_rear, "/arm/rear");
