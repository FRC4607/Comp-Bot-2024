...
public class WheelRadiusCharacterization extends Command {
    private static final double driveRadius = Units.inchesToMeters(Math.hypot(
            Constants.DrivetrainConstants.kFrontLeftXPosInches, Constants.DrivetrainConstants.kFrontLeftYPosInches));
    ...
    private SwerveRequest.RobotCentric req = new RobotCentric()
    ...
    public WheelRadiusCharacterization(CommandSwerveDrivetrain drive) {
        this.drive = drive;
        this.gyroYawRadsSupplier = () -> {
            return drive.getState().Pose.getRotation().getRadians();
        };
